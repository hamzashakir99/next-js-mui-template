  ...
  const handleClickShowPassword = () => {
    dispatch(
      loginSetting({
        ...
        login: {
          ...loginSelector.login,
          show_password: !loginSelector.login.show_password,
        },
      })
    );
  };
              ...
              >
                <Grid item md={12} xs={12}>
                  ...
                  >
                    <TextField
                      type={
                        loginSelector.login.show_password ? "text" : "password"
                      }
                      label="Password"
                      onChange={(event) => {
                        dispatch(
                        ...
                        endAdornment: (
                          <InputAdornment position="end">
                            <IconButton
                              ...
                              edge="end"
                            >
                              {loginSelector.login.show_password ? (
                                <VisibilityOff />
                              ) : (
                                <Visibility />
                              )}
                    ...
                    />
                    {loginSelector.login.password && (
                      <>
                        <PasswordStrengthBar
                          minLength={8}
                          style={{ margin: "20px 0 0" }}
                          className="password-validator"
                          password={loginSelector.login.password}
                        />
                        <PasswordChecklist
                          rules={[
                            "minLength",
                          ...
                          minLength={8}
                          value={loginSelector.login.password}
                          className="password-validator"
            ...
            >
              <Grid item md={6} xs={12}>
                ...
                >
                  <PinInput
                    length={4}
                    initialValue={loginSelector.login.code}
                    onChange={(value) => {
                      dispatch(
                        loginSetting({
                          ...loginSelector,
